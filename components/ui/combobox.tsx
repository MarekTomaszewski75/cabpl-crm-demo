...
/** Radix Sheet/Dialog ustawia `pointer-events: none` na body — portale Combobox muszą to nadpisać. */
export function isComboboxPortalTarget(target: EventTarget | null): boolean {
  return (
    target instanceof Element &&
    Boolean(
      target.closest(
        '[data-slot="combobox-content"], [data-slot="combobox-positioner"]',
      ),
    )
  )
}
