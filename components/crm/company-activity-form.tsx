...
export function CompanyActivityForm({ client }: CompanyActivityFormProps) {
  const { user } = useSession()
  const { users, contacts, addCompanyActivity } = useDemoData()
  ...
  return (
    <div className="flex flex-col gap-4">
      <FieldGroup>
        <Field>
          <FieldLabel htmlFor="activity-title">Nazwa</FieldLabel>
          <Input
            id="activity-title"
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <Field>
            <FieldLabel htmlFor="activity-start-date">Data rozpoczęcia</FieldLabel>
            <Input
          ...
          <Field>
            <FieldLabel htmlFor="activity-end-date">Data zakończenia</FieldLabel>
            <Input
          ...
          <Field>
            <FieldLabel htmlFor="activity-start-time">Godzina od</FieldLabel>
            <Input
          ...
          <Field>
            <FieldLabel htmlFor="activity-end-time">Godzina do</FieldLabel>
            <Input
        ...
        <Field orientation="horizontal" className="items-center">
          ...
          />
          <FieldLabel htmlFor="activity-all-day" className="font-normal">
            Na cały dzień
          </FieldLabel>
        </Field>
        ...
        <Field>
          <FieldLabel htmlFor="activity-note">Notatka</FieldLabel>
          <Textarea
            id="activity-note"
          ...
          <div className="flex flex-col gap-3">
            ...
            <ActivityOutlinedField label="Uczestnicy">
              <ActivityParticipantsField
                ...
                preferredContactIds={client.contactIds}
