...
type CompanyMeetingsListProps = {
  meetings: Meeting[]
}

export function CompanyMeetingsList({ meetings }: CompanyMeetingsListProps) {
  return (
    <Card size="sm" id="company-meetings-section">
        ...
        {meetings.length === 0 ? (
          <Empty className="border py-6">
            <EmptyHeader>
              ...
              <EmptyDescription>
                Brak spotkań powiązanych z tą firmą.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        ) : (
