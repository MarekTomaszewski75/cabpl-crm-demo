...
type LeadMeetingsListProps = {
  meetings: Meeting[]
}

export function LeadMeetingsList({ meetings }: LeadMeetingsListProps) {
  const sorted = [...meetings].sort(
    (a, b) => new Date(a.startsAt).getTime() - new Date(b.startsAt).getTime(),
  )

  return (
    <Card size="sm" id="lead-meetings-section">
        ...
        {sorted.length === 0 ? (
          <Empty className="border py-6">
            <EmptyHeader>
              ...
              <EmptyDescription>
                Brak spotkań powiązanych z tym leadem.
              </EmptyDescription>
            </EmptyHeader>
          </Empty>
        ) : (
